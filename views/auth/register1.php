...
<body>
  ...
  <header role="banner">
    ...
    <section class="containerGlobal">
        ...
        <div class="container">
          <form  method="POST" action="../../controllers/auth/register.php" class="was-validated needs-validation" id="form">
            <h2>Please Fill out form to Register!</h2>
            <form id="register-form">
              <div class="form-group">
                <label for="fullname" for="validationCustom01" >Full name :</label>
                <input type="text" name="fullname" value="<?php if(!empty($_SESSION ['fullname'])) echo $_SESSION ['fullname']; ?>" class="form-control" id="validationCustom01" pattern="[A-Za-z]+ +[A-Za-z]{3,}" required>
              ...
              <div class="form-group">
                ...
                <input type="text" name="Username" value="<?php if(!empty($_SESSION ['Username'])) echo $_SESSION ['Username']; ?>" class="form-control" id="validationCustomUsername" id="username" required pattern="[A-Za-z0-9_%+\-]{4,}">
                <div class="valid-feedback">
                  Looks good!
                </div>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" value="<?php if(!empty($_SESSION ['email'])) echo $_SESSION ['email']; ?>" id="validationCustomUsername" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" class="form-control" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="password" name="passwords" value="<?php if(!empty($_SESSION ['password'])) echo $_SESSION ['password']; ?>" id="password" class="form-control" pattern=".{6,}" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="password" name="confirm_password" value="<?php if(!empty($_SESSION ['confirm_password'])) echo $_SESSION ['confirm_password']; ?>" id="confirm-password"  pattern=".{6,}" required>
              ...
              <div class="form-group">
                ...
                <?php
                if(!empty($_SESSION ['error_user'])) echo '<p style="color: red;" >'. $_SESSION ['error_user'] .'</p>' ;
                ?>
              </div>
            </form>
